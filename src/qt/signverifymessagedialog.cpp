    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a Juwelz address"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a Juwelz address"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter Juwelz signature"));
#endif
